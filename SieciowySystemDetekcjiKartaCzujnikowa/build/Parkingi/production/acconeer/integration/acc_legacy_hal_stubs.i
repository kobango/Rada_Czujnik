# 1 "acconeer/integration/acc_legacy_hal_stubs.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "acconeer/integration/acc_legacy_hal_stubs.c" 2



# 1 "D:\\Programy\\Microchip\\xc8\\v2.05\\pic\\include\\c99\\stdbool.h" 1 3
# 5 "acconeer/integration/acc_legacy_hal_stubs.c" 2
...
# 4 "D:\\Programy\\Microchip\\xc8\\v2.05\\pic\\include\\c99\\stdint.h" 2 3
...
# 6 "acconeer/integration/acc_legacy_hal_stubs.c" 2
...
# 10 "D:\\Programy\\Microchip\\xc8\\v2.05\\pic\\include\\c99\\stdlib.h" 3
...
# 8 "acconeer/integration/acc_legacy_hal_stubs.c" 2
# 1 "acconeer/rss/include\\acc_types.h" 1
# 16 "acconeer/rss/include\\acc_types.h"
typedef uint32_t acc_sensor_t;
# 26 "acconeer/rss/include\\acc_types.h"
typedef enum {
...
# 9 "acconeer/integration/acc_legacy_hal_stubs.c" 2

typedef void (*acc_board_isr_t)(acc_sensor_id_t);

_Bool acc_board_init(void);
...
_Bool acc_board_wait_for_sensor_interrupt(acc_sensor_id_t sensor_id, uint32_t timeout_ms);
void acc_board_sensor_transfer(acc_sensor_id_t sensor_id, uint8_t *buffer, size_t buffer_length);
_Bool acc_board_gpio_init(void);
...
_Bool acc_os_semaphore_wait(acc_os_semaphore_t sem, uint16_t timeout_ms);
...
_Bool acc_os_multithread_support(void);
...
# 61 "acconeer/integration/acc_legacy_hal_stubs.c"
_Bool acc_board_init(void)
{
 return 0;
}
