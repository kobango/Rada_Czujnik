# 1 "acconeer/src/example_power_bin_once.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "acconeer/src/example_power_bin_once.c" 2
...
# 5 "acconeer/src/example_power_bin_once.c" 2
...
# 6 "acconeer/src/example_power_bin_once.c" 2
...
# 7 "acconeer/src/example_power_bin_once.c" 2
...
# 8 "acconeer/src/example_power_bin_once.c" 2
...
# 10 "acconeer/src/example_power_bin_once.c" 2
...
# 11 "acconeer/src/example_power_bin_once.c" 2
# 1 "acconeer/rss/include\\acc_service_power_bins.h" 1
...
# 10 "acconeer/rss/include\\acc_service_power_bins.h" 2
# 26 "acconeer/rss/include\\acc_service_power_bins.h"
typedef struct
{
...
# 102 "acconeer/rss/include\\acc_service_power_bins.h"
...
# 147 "acconeer/rss/include\\acc_service_power_bins.h"
extern acc_service_status_t acc_service_power_bins_execute_once(acc_service_handle_t handle, float *data, uint16_t data_length,
                                                                acc_service_power_bins_result_info_t *result_info);
# 12 "acconeer/src/example_power_bin_once.c" 2

# 1 "acconeer/rss/include\\acc_version.h" 1
# 14 "acconeer/src/example_power_bin_once.c" 2

# 1 "acconeer/src/example_power_bin_once.h" 1
# 12 "acconeer/src/example_power_bin_once.h"
int acc_example_power_bin_once(void);
# 16 "acconeer/src/example_power_bin_once.c" 2
# 39 "acconeer/src/example_power_bin_once.c"
static void configure_detector(acc_service_configuration_t distance_configuration)
{
 ...
 else
 {
  ...
  acc_sweep_configuration_requested_start_set(sweep_configuration, (0.05f));
  acc_sweep_configuration_requested_length_set(sweep_configuration, (0.4f));
...
int acc_example_power_bin_once(void)
{
 ...
 if (power_bins_configuration == ((void*)0))
 {
 ...
 status = acc_service_power_bins_execute_once(power_bins_handle, radar_data, n_bins, ((void*)0));
