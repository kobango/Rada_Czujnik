...
# 14 "acconeer/rss/include\\acc_definitions.h" 2
...
# 8 "acconeer/integration\\acc_hal_integration.h" 2
...
# 11 "acconeer/src/newenv.c" 2
# 1 "acconeer/rss/include\\acc_service_envelope.h" 1
# 10 "acconeer/rss/include\\acc_service_envelope.h"
# 1 "acconeer/rss/include/acc_service.h" 1
...
# 10 "acconeer/rss/include/acc_service.h" 2
# 37 "acconeer/rss/include/acc_service.h"
typedef enum
{
...
typedef struct
{
 ...
 _Bool sensor_communication_error;
 _Bool data_saturated;
...
# 132 "acconeer/rss/include\\acc_service_envelope.h"
_Bool acc_service_envelope_compensate_phase_get(acc_service_configuration_t service_configuration);
# 145 "acconeer/rss/include\\acc_service_envelope.h"
void acc_service_envelope_compensate_phase_set(acc_service_configuration_t service_configuration, _Bool compensate_phase);
# 160 "acconeer/rss/include\\acc_service_envelope.h"
float acc_service_envelope_running_average_factor_get(acc_service_configuration_t service_configuration);
# 175 "acconeer/rss/include\\acc_service_envelope.h"
void acc_service_envelope_running_average_factor_set(acc_service_configuration_t service_configuration, float factor);
# 189 "acconeer/rss/include\\acc_service_envelope.h"
...
# 234 "acconeer/rss/include\\acc_service_envelope.h"
acc_service_status_t acc_service_envelope_execute_once(acc_service_handle_t handle, uint16_t *data, uint16_t data_length,
                                                       acc_service_envelope_result_info_t *result_info);
# 12 "acconeer/src/newenv.c" 2

# 1 "acconeer/rss/include\\acc_version.h" 1
# 14 "acconeer/src/newenv.c" 2

# 1 "acconeer/src/newenv.h" 1
# 12 "acconeer/src/newenv.h"
int my_envelope(void);
# 16 "acconeer/src/newenv.c" 2
# 38 "acconeer/src/newenv.c"
...
int my_envelope(void)
{
 ...
 if (envelope_configuration == ((void*)0))
 {
