...
# 11 "acconeer/src/newsparse.c" 2
# 1 "acconeer/rss/include\\acc_service_sparse.h" 1
...
# 10 "acconeer/rss/include\\acc_service_sparse.h" 2
# 25 "acconeer/rss/include\\acc_service_sparse.h"
typedef struct
{
...
# 104 "acconeer/rss/include\\acc_service_sparse.h"
...
# 148 "acconeer/rss/include\\acc_service_sparse.h"
acc_service_status_t acc_service_sparse_execute_once(acc_service_handle_t handle, uint16_t *data, uint16_t data_length,
                                                     acc_service_sparse_result_info_t *result_info);
# 12 "acconeer/src/newsparse.c" 2

# 1 "acconeer/rss/include\\acc_version.h" 1
# 14 "acconeer/src/newsparse.c" 2

# 1 "acconeer/src/newsparse.h" 1
# 12 "acconeer/src/newsparse.h"
int my_sparse(void);
# 16 "acconeer/src/newsparse.c" 2
# 38 "acconeer/src/newsparse.c"
static void configure_detector(acc_service_configuration_t distance_configuration)
{
 ...
 else
 {
  ...
  acc_sweep_configuration_requested_start_set(sweep_configuration, (0.5f));
  acc_sweep_configuration_requested_length_set(sweep_configuration, (1.49f));
...
int my_sparse(void)
{
 ...
 if (sparse_configuration == ((void*)0))
 {
